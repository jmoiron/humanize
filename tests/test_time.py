...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            NOW - dt.timedelta(seconds=ONE_HOUR + FOUR_MILLISECONDS),
            "1 hour and 0.00 seconds ago",
        ),
        (
            NOW - dt.timedelta(seconds=ONE_DAY + FOUR_MILLISECONDS),
            "1 day and 0.00 seconds ago",
        ),
    ],
)
